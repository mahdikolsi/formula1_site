...
<div class="row">
    ...
    <div class="col-md-4 mb-4">
        <div class="card">
            <img src="<?php echo e($driver['photo']); ?>" class="card-img-top" alt="<?php echo e($driver['name']); ?>">
            <div class="card-body">
                <h5 class="card-title"><?php echo e($driver['name']); ?></h5>
                <p class="card-text"><strong>Team:</strong> <?php echo e($driver['team']); ?></p>
                <p class="card-text"><strong>Nationality:</strong> <?php echo e($driver['nationality']); ?></p>
                <p class="card-text"><?php echo e($driver['bio']); ?></p>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\formula1_site\resources\views/drivers.blade.php ENDPATH**/ ?>