...
<div class="row">
    <div class="col-md-4 mb-4">
        ...
        <img src="<?php echo e(asset('storage/2.avif')); ?>" class="card-img-top" alt="News Image">
            <div class="card-body">
    ...
    <div class="col-md-4 mb-4">
    <div class="card h-100 shadow-sm">
        <img src="<?php echo e(asset('storage/1.png')); ?>" class="card-img-top" alt="News Image">
        <div class="card-body">
    ...
    <div class="col-md-4 mb-4">
        <div class="card h-100 shadow-sm">
        <img src="<?php echo e(asset('storage/3.jpg')); ?>" class="card-img-top" alt="News Image">
            <div class="card-body">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\formula1_site\resources\views/home.blade.php ENDPATH**/ ?>